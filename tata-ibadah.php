...
<html lang="en">
    <head>
        <title><?=$seo['tata-ibadah-title'];?></title>
        <meta name="keywords" content="<?=$seo['tata-ibadah-keyword'];?>">
        <meta name="description" content="<?=$seo['tata-ibadah-desc'];?>">
        ...
        <section class="breadcrumb_area br_image">
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Tata Ibadah</h2>
                    <ol class="breadcrumb">
                        <li><a href="<?=$path['home'];?>">Home</a></li>
                        <li class="active">Tata Ibadah</li>
                    </ol>
                </div>
            </div>
        </section>
